...
if(isset($_POST['go']))
{
    ...
    if($uname!= "" && $pass !=""){
        $sql_query="select count(*) as cntUser from usertable where username='".$uname."' and password='".$pass."'";
...
<html>
   ...
   #admin a{color:red; text-decoration: none;}
   .eye{
       position:absolute;
       right:6%;
       top:49%;
   ...
   #eye1{
    ...
    <body>
        <form class="box" action="#" method="post">
          ...
          <a class="create" href="signup.php">&diams; Create your account &diams;</a> 
          <p id="admin">For <a href="adlogin.php">Admin</a></p>
        </form>
